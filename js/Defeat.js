var randomTitle2 = ['Try again!', 'Damn..', 'You can do it!'];
var defeatName = document.querySelector('.Defeat-title2');
var randomNummer2 = Math.random()*3;
randomNummer2 = Math.floor(randomNummer2);
defeatName.textContent = randomTitle2[randomNummer2];
